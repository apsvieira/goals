<script lang="ts">
    ...
    onMount(async () => {
        ...
        try {
            ...
            console.error(
                "[NotificationSettings] Failed to register resume listener:",
                err,
            );
        }
    });
...
<div class="notifications-section">
    ...
    <div class="frequency-group">
        ...
        <div
            class="option-list"
            role="radiogroup"
            aria-label={$_("notifications.frequencyLabel")}
        >
            <button
                type="button"
                class="option"
    ...
    {#if settings.frequency !== "off"}
        <div class="row">
            <label class="row-label" for="notification-time"
                >{$_("notifications.time")}</label
            >
            <input
    ...
    {#if settings.frequency === "weekly"}
        <div class="row">
            <label class="row-label" for="notification-weekday"
                >{$_("notifications.dayOfWeek")}</label
            >
            <select
